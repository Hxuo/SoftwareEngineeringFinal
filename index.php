...
<html lang="en">
  <head>
    ...
    <title>Aniah Brow Aesthetic</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link rel="stylesheet" href="./Frontend-User/index.css">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto d-flex align-items-center">
        ...
        <?php if ($isLoggedIn): ?>
        <li class="nav-item">
         <a class="nav-link" href="#" onclick="openUserAppointmentModal()">Appointment</a>
        </li>
        <?php endif; ?>
        <li class="nav-item">
...
<span class="error-message-create" id="confirmpassword-error"></span> <!-- Added this line -->
...
<div id="termsModal" class="modalTNC">
    <div class="modal-content-TNC">
        <button class="close-create-TNC" onclick="closeTermsModal()">×</button>
...
By booking an appointment and availing of our services, you confirm that you have read, understood, and agreed to our Terms and Conditions and Privacy Policy.</p>
      <div class="checkbox-container">
       ...
       <label for="termsCheckbox">I Agree</label>
      </div>
    </div>
</div>

<!-- Terms and Condition and Privacy Policy Footer -->
<div id="TNCModal" class="modalTNC">
    <div class="modal-content-TNC">
        <button class="close-create-TNC" onclick="closeTNCModal()">×</button>
        <h3>Terms and Conditions - Aniah Brow Aesthetic</h3>
        <p>Welcome to Aniah Brow Aesthetic! To ensure the best experience for all our clients, please carefully read and understand our Terms and Conditions before booking an appointment or availing of any services.</p>
...
By booking an appointment and availing of our services, you confirm that you have read, understood, and agreed to our Terms and Conditions and Privacy Policy.</p>
    ...
    <div class="carousel-container">
      <div id="styledCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./Assests/carouselpic1.jpg" class="d-block w-100" alt="Carousel Image">
            <div class="carousel-caption">
              <h3>Welcome to Aniah Brow Aesthetic</h3>
            
            </div>
          </div>
          <div class="carousel-item">
            <img src="./Assests/carouselpic2.jpg" class="d-block w-100" alt="Carousel Image">
            <div class="carousel-caption">
          ...
          <div class="carousel-item">
            <img src="./Assests/carouselpic3.jpg" class="d-block w-100" alt="Carousel Image">
            <div class="carousel-caption">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#styledCarousel" data-bs-slide="prev" aria-label="Previous">
          <img src="./Assests/arrawLeft.png" alt="Previous" class="carousel-control-prev-img">
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#styledCarousel" data-bs-slide="next" aria-label="Next">
          <img src="./Assests/arrowRight.png" alt="Previous" class="carousel-control-prev-img">
        </button>
      </div>
    </div>
...
<div id ="services" class="card-services-section">
  <h1 class="services-title">What We Can Offer</h1>
  <!--<p class="services-subtitle">What we can do for you</p> --->
  <div id="carousel-container">
    ...
    <div id="card-container">
      <div class="card">
        <img src="./Assests/photocard1.jpg" alt="Image 1">
        <p>Nails</p>
      </div>
      <div class="card">
        <img src="./Assests/removal.jpg" alt="Image 1">
        <p>Nails Removal</p>
      </div>
      <div class="card">
        <img src="./Assests/softGel.jpeg" alt="Image 1">
        <p>Soft Gel Extensions</p>
      </div>
      <div class="card">
        <img src="./Assests/photocard2.jpg" alt="Image 2">
        <p>Eyebrows</p>
      </div>
      <div class="card">
        <img src="./Assests/lashes.jpeg" alt="Image 2">
        <p>Eyelash</p>
      </div>
      <div class="card">
        <img src="./Assests/photocard3.jpg" alt="Image 3">
        <p>RF Cavitation</p>
      </div>
      <div class="card">
        <img src="./Assests/photocard4.jpg" alt="Image 4">
        <p>Meso Lipo</p>
      </div>
      <div class="card">
        <img src="./Assests/photocard5.jpg" alt="Image 5">
        <p>Gluta drip</p>
      </div>
    </div>
        ...
        <div class="service-card-container"> 
          <div class="service-card">
            <div class="card-image">
              <img src="./Assests/logoExtended.jpg" alt="Service Image">
             
            </div>
            <div class="card-content">
              <h3 class="card-title">Glow Your Face & Vitality With Our Best Service</h3>
              <p class="card-description">
                Aniah Aesthetic offers a full range of beauty and self-care treatments, specializing in cosmetic enhancement and skincare. Our services include expert eyebrow shaping, rejuvenating facial treatments, and premium eyelash enhancements—all designed to bring out your natural beauty. Experience top-tier aesthetic care tailored to your unique needs.
              </p>
              <ul class="card-features">
                <li><span class="feature-icon"></span> Well sanitized equipment: We prioritize your health by using well-maintained and sanitized equipment. Each item is cleaned thoroughly between uses, and our staff follows strict protocols to ensure a hygienic environment.</li>
                <li><span class="feature-icon"></span> Offer Discounts: We offer regular discounts and promotions, including seasonal offers, bundle deals, and loyalty rewards, so you can enjoy high-quality services at a lower cost.</li>
                <li><span class="feature-icon"></span>Appointment scheduling: Scheduling appointments is easy with our online booking system or phone reservations. Our flexible scheduling and reminders ensure a seamless, timely experience.</li>
        ...
        <div class="about-us-section" id = "about-us">
          <div class="about-content">
            ...
            <p class="about-description">
              At Aniah Aesthetic, we are dedicated to enhancing natural beauty through expert cosmetic care. Specializing in eyebrow design, rejuvenating facials, and premium eyelash enhancements, we provide high-quality treatments tailored to your needs. Our mission is to help you look and feel your best with professional beauty services in a comfortable and welcoming environment.<br>
        
          </div>
          <div class="image-content">
            <img src="./Assests/carouselpic2.jpg" alt="Glow From Within" />
...
<div id="editmodal" class="modal-create">
    <div class="modal-create-content">
        ...
        <input type="text" id="editfullname" placeholder="Enter your Full Name" required readonly onblur="validateEditFullName()">
        ...
        <div class="inline-group">
            <div>
                ...
                <input type="text" id="editemail" placeholder="Enter your email" required readonly onblur="validateEditEmail()">
       ...
       oninput="validateEditPhoneNumber()" onblur="validateEditPhoneNumber()">
        ...
        <input type="text" id="editAddress" placeholder="Enter your Address" required readonly onblur="validateEditAddress()">
        <span class="error-message-edit" id="editAddress-error"></span>

        <!-- Region and City Dropdown -->
        <label for="editregion">Region:</label>
<select id="editregion" onchange="loadCities()" required>
    <option value="" disabled selected>Select Region</option>
</select>
...
<span class="error-message-edit" id="editcity-error"></span>
        ...
        <input type="text" id="editbarangay" placeholder="Enter Barangay" required readonly onblur="validateEditBarangay()">
        ...
        <div class="password-container-1">
            ...
            <img src="./Assests/hide.png" id="togglePassBtn5" class="toggle-icon" onclick="togglePassword('editpassword', 'togglePassBtn5')">
        </div>
        ...
        <div class="password-container-1">
            ...
            <img src="./Assests/hide.png" id="togglePassBtn6" class="toggle-icon" onclick="togglePassword('editconfirmpassword', 'togglePassBtn6')">
        </div>
        <span class="error-message-edit" id="editconfirmpassword-error"></span>
      
        <button class="proceed-create-btn" id="proceedCreateBtn" onclick="createEditprocess()">Save Changes</button>
    </div>
</div>
...
<div id="successModal" class="modal-success">
    <div class="modal-success-content">
        <p>Service Added Failed</p>
    </div>
</div>


<div id="staffpass1" class="staffpassmanage1">
    <div class="modal-content-staffmanagepass1">
        <button class="close-create" onclick="closeManagementModal()">×</button>
        <div class="form-group">
            <label for="staffpassword">FOR MANAGEMENT ONLY</label>
            <div class="password-container">
                <input type="password" id="staffpassword" class="form-input" placeholder="Enter your password" required>
                <img src="./Assests/hide.png" id="togglePassBtn7" class="toggle-icon" onclick="togglePassword('staffpassword', 'togglePassBtn7')">
            </div>
            <span id="staffpassword-error" class="error-message"></span> <!-- Error message -->
            <div class="button-group">
                <button class="proceed-login-btn" onclick="staffprocess()">Login</button>
            </div>
        </div>
    </div>
</div>
...
/* 
    ...
    const userData = {
      ...
      name: <?php echo json_encode($fullName); ?>, 
        ...
        phonenumber: <?php echo json_encode($phonenumber); ?>, // Tamang column name
...
<div id="confirmationModal" class="modal">
    <div class="modal-content">
        <span class="close" onclick="cancelAddToCart()">&times;</span>
        <br> 
        <h2>Confirm Service Selection</h2>
        <p>Are you sure you want to avail <strong id="confirmServiceName"></strong> for <strong id="confirmServicePrice"></strong>?</p>
        <div class="modal-buttons">
        <button onclick="confirmAddToCart()" class="confirm-btn">Yes</button>
        <button onclick="cancelAddToCart()" class="cancel-btn">No</button>
...
<!-- Modal Structure -->
<div id="userAppointmentModal" class="user-appointment-modal">
    <div class="user-appointment-modal-content">
        <span class="user-appointment-close" onclick="closeUserAppointmentModal()">&times;</span>
        
        <!-- Scheduled Table -->
        <section class="user-schedule-container">
            <h2>Scheduled</h2>
...
<div id="refundModal" class="refund-modal">
    <div class="refund-modal-content">
        <button class="close-modal-refund" onclick="closeRefundModal()">×</button>
        <h2>Cancel Appointment</h2>
        <p>Are you sure you want to cancel your appointment and refund your payment?</p>
        <div class="refund-reason">
            <label for="refundReason">Reason:</label>
            <textarea id="refundReason" placeholder="Please specify your reason for cancellation..." required></textarea>
        </div>
        <div class="refund-modal-buttons">
        <button class="confirm-btn" onclick="processRefund()">Yes, Cancel & Refund</button>
        <button class="cancel-btn" onclick="closeRefundModal()">No, Keep Appointment</button>
...
<div id="rescheduleModal" class="modal">
    <div class="modal-content appoint-now-section">
        <!-- Close Button -->
        <button id="close-modal-resched" class="close-modal-payment" onclick="closeRescheduleModal()">×</button>

        <!-- Modal Content -->
        <div class="form-container">
            <h2 class="appoint-title">RESCHEDULE APPOINTMENT</h2>
            <p class="appoint-description">
                Please select a new date and time for your appointment.
            </p>
            <form onsubmit="submitReschedule(event)">
                <input type="hidden" id="reschedAppointmentId" />

                <div class="form-group">
                    <label for="reschedDateInput">Select New Date:</label>
                    <input type="text" id="reschedDateInput" placeholder="Select Date" readonly onclick="openReschedCalendar()" required />
                </div>

                <div class="form-group">
                    <label for="reschedTimeSelect">Select New Time:</label>
                    <select id="reschedTimeSelect" required>
                        <option value="">Select Time</option>
                    </select>
                </div>

                <button type="submit" class="confirm-button">Confirm Reschedule</button>
            </form>
        </div>
    </div>
</div>

<!-- Calendar Modal for Rescheduling -->
<div id="calendarModalResched" class="modal-calendar-resched">
    <div class="modal-calendar-content-resched">
        <div class="calendar-header">
            <button onclick="loadReschedCalendar('current')">Current Month</button>
            <button onclick="loadReschedCalendar('next')">Next Month</button>
            <button onclick="closeReschedCalendar()">×</button>
        </div>
        <div id="calendarContainerResched"></div>
    </div>
</div>
         ...
         <!-- FOOTER Section  -->
         <footer id = "footers" class="footer-section">
          <div class="footer-content">
            <div class="footer-column">
              <h3>Information</h3>
              <ul>
                <li><a href="#">Our Story</a></li>
                <li><a href="https://maps.app.goo.gl/MobYGVp19s1ArZjM7">Location</a></li>
                <li><a href="#" onclick="openTNCModal()">Terms and Condition</a></li>
              </ul>
            </div>
           
            <div class="footer-column">
              <h3>Help Center</h3>
              <p>aniahbrowaesthetics@gmail.com</p>
              <p>0954 972 8713</p>
            </div>
          ...
          <div class="footer-bottom">
            <p>© Aniah Brow Aesthetics, 2025 All Rights Reserved</p>
    ...
    <script src="offerservices.js"></script>
